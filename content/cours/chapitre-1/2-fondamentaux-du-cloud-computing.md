...
<nav class="page-sequence"><a href="cours/chapitre-1/1-introduction">Pr&eacute;c&eacute;dent</a> <a href="cours/chapitre-1/index">Sommaire</a> <a href="cours/chapitre-1/3-modeles-de-services-iaas-paas-et-saas">Suivant</a></nav>
...
![](assets/schemas/ch1-capture-02-17ee61f5.png)
...
Avant d'étudier le tableau, utilisez le [simulateur interactif de responsabilité partagée](static/quiz-aws/simulateur-responsabilite-partagee.htm). Comparez EC2, RDS et Lambda : plus le service est managé, plus AWS prend en charge de couches techniques, sans jamais devenir responsable de la classification des données ni des autorisations décidées par le client.
...
![](assets/schemas/ch1-capture-03-37dd1c7c.png)
