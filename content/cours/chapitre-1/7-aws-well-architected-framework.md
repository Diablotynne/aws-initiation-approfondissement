...
<nav class="page-sequence"><a href="cours/chapitre-1/6-presentation-daws-et-de-son-ecosysteme">Pr&eacute;c&eacute;dent</a> <a href="cours/chapitre-1/index">Sommaire</a> <a href="cours/chapitre-1/8-aws-management-console">Suivant</a></nav>
...
<a class="schema-zoom" href="assets/schemas/well-architected-six-piliers.svg" target="_blank" rel="noopener" aria-label="Agrandir le schéma"><img src="assets/schemas/well-architected-six-piliers.svg"
     alt="Les six piliers du Well-Architected Framework organisés autour d'une architecture bien conçue : Sécurité, Excellence opérationnelle, Fiabilité, Efficacité des performances, Optimisation des coûts, Durabilité"
     style="display:block; margin:auto; width:90%"></a>

Les six piliers ne s'appliquent pas en séquence : ils se travaillent en continu et souvent en tension les uns avec les autres (par exemple, plus de résilience implique généralement plus de coûts) — le rôle de l'architecte est de trouver le bon équilibre pour chaque projet, pas de maximiser chaque pilier isolément.
