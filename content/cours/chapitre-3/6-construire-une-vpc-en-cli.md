---
title: "6. Construire une VPC en CLI"
description: "\"Chapitre 3 — Amazon VPC et bases de données AWS\" - 6. Construire une VPC en CLI"
---

<nav class="page-sequence"><a href="cours/chapitre-3/5-points-importants-et-pieges-frequents">Pr&eacute;c&eacute;dent</a> <a href="cours/chapitre-3/index">Sommaire</a> <a href="cours/chapitre-3/ressources">Suivant</a></nav>
...
Le réseau et les données sont maintenant en place. Le Chapitre 4 y installe le calcul et le stockage — instances EC2, buckets S3, et les conteneurs (ECS/ECR/Fargate) comme alternative moderne à la VM classique.
